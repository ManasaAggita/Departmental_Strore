...
const Navbar = () => {
	...
	return (
		<header className='fixed top-0 left-0 w-full bg-cyan bg-cyan-600 shadow-lg z-40 transition-all duration-300 border-b border-gray-200'>
			<div className='container mx-auto px-4 py-3'>
				<div className='flex flex-wrap justify-between items-center'>
					...
					<nav className='flex flex-wrap items-center gap-4'>
						<Link
							to={"/"}
							className='text-white font-bold hover:text-orange-600 transition duration-300
					 ease-in-out'
						>
							Home
						</Link>
						{user && (
							<Link
								to={"/cart"}
								className='relative group text-white-300 hover:text-white transition duration-300 
							ease-in-out'
							>
