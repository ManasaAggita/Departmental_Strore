...
//const categories = ["furniture", "electronic devices", "home appliances", "home decor"];
///*
const categories = {
	furniture: ["couches", "tables", "chairs"],
	electronic_devices: ["smart-phones", "laptops", "tablets"],
	home_appliances: ["microwave", "toaster", "blender"],
home_decor:["vases", "picture-frames", "clocks"],
};
//*/
