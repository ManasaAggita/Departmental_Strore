	...
	return (
		...
		>
			<div className='space-y-4'>
				<div>
					<label htmlFor='voucher' className='mb-2 block text-sm font-medium text-black-300'>
			...
			{isCouponApplied && coupon && (
				<div className='mt-4'>
					<h3 className='text-lg font-medium text-black'>Applied Promo code</h3>
					...
					<motion.button
						type='button'
						className='mt-2 flex w-full items-center justify-center rounded-lg bg-cyan-600 
            px-5 py-2.5 text-sm font-medium text-white hover:bg-cyan-700 focus:outline-none
			...
			{coupon && (
				<div className='mt-4'>
					<h3 className='text-lg font-medium text-black'>Your Available Promo Code:</h3>
					<p className='mt-2 text-sm text-gray-400'>
						{coupon.code} - {coupon.discountPercentage}% off
					</p>
				</div>
